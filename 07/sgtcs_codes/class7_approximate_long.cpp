...
vector<ul> counter (NR_THREADS-1);
...
static void globalize_count ( ul *counter, ul *countermax ) {
	globalcount += *counter;
	*counter = 0;
...
static void balance_count ( ul *counter, ul *countermax ) {
...
bool add_count ( ul delta, ul *counter, ul *countermax ) {
