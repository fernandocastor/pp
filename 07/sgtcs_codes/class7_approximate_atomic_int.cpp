...
ul num_online_thread = NR_THREADS;
bool finish = false;

vector<atomic<int>> counter (NR_THREADS-1);
...
static void globalize_count ( atomic<int> *counter, ul *countermax ) {
...
static void balance_count ( atomic<int> *counter, ul *countermax ) {
