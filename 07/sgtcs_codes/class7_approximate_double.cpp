...
vector<double> counter (NR_THREADS-1);
...
static void globalize_count ( double *counter, ul *countermax ) {
...
static void balance_count ( double *counter, ul *countermax ) {
...
bool add_count ( ul delta, double *counter, ul *countermax ) {
