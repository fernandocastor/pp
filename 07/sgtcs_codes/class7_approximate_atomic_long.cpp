...
vector<atomic<long>> counter (NR_THREADS-1);
...
static void globalize_count ( atomic<long> *counter, ul *countermax ) {
...
static void balance_count ( atomic<long> *counter, ul *countermax ) {
...
bool add_count ( ul delta, atomic<long> *counter, ul *countermax ) {
