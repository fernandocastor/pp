 ...
 *
 * Avoid starvation by adopting a simple solution using
 * assymetric acquirement, even philosophers start from
 * right, odd philosophers start from left. Because the
 * eating/thinking period are random no philosopher
 * will starve. But this solution is not complete fair.
 *
